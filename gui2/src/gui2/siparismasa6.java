...
public class siparismasa6 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new siparismasa6();
					frame.setVisible(true);
					frame.setTitle("MASA 6");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 * @throws IOException 
	 */
	public siparismasa6() throws IOException {
		setTitle("MASA 6");
       ...
       final BufferedImage image = ImageIO.read(new File("C:\\Users\\seyme\\Desktop\\zad1.jpg"));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					while(rs.next()) {
						if(rs.getString("adi").equals(data1)&&data1!=null) {
							...
							masabaglanti.guncellemasa6esit(data1,adet ,adetmasa);
							c=0;
						}
				...
				if(c==1) {
					int adet=Integer.parseInt(textField.getText());
					try {
						masabaglanti.verigirmasa6(adet,data1 ,data2 );
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					masabaglanti.guncellemasa6(data11,data22,odeadet  );
				} catch (SQLException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				}
	...
	void listelemasa6() throws SQLException {
