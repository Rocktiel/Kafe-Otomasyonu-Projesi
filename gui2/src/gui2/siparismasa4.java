...
public class siparismasa4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new siparismasa4();
					frame.setVisible(true);
					frame.setTitle("MASA 4");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 * @throws IOException 
	 */
	public siparismasa4() throws IOException {
		setTitle("MASA 4");
       ...
       final BufferedImage image = ImageIO.read(new File("C:\\Users\\seyme\\Desktop\\zad1.jpg"));
		...
		JLabel lblNewLabel_2 = new JLabel("MASA 4");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					while(rs.next()) {
						if(rs.getString("adi").equals(data1)&&data1!=null) {
							...
							masabaglanti.guncellemasa4esit(data1,adet ,adetmasa);
							c=0;
						}
				...
				if(c==1) {
					int adet=Integer.parseInt(textField.getText());
					try {
						masabaglanti.verigirmasa4(adet,data1 ,data2 );
		...
		btnNewButton_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					masabaglanti.guncellemasa4(data11,data22,odeadet  );
				} catch (SQLException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				}
	...
	void listelemasa4() throws SQLException {
